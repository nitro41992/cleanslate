...
export function Autocomplete({
  ...
  return (
    ...
    >
      ...
      {/* Keyboard hint */}
      <div className="px-3 py-1 text-[10px] text-slate-500 border-t border-slate-700 flex items-center justify-between">
        <span>
          <kbd className="px-1 py-0.5 bg-slate-700 rounded text-[9px]">Tab</kbd> to select
        </span>
        <span>
          <kbd className="px-1 py-0.5 bg-slate-700 rounded text-[9px]">Esc</kbd> to close
        </span>
      </div>
    </div>
  )
